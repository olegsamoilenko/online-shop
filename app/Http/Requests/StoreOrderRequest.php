...
class StoreOrderRequest extends FormRequest
{
  ...
  public function messages(): array
  {
    return [
      ...
      'name.regex' => 'Please enter your name correctly.',
      'surname.required' => 'Last name required.',
      'surname.regex' => 'Please enter your last name correctly.',
      ...
      'postOffice.required' => 'Post office number is required.',
