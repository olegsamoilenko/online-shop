...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
          'title' => ['required', 'string', 'min:2', 'max:100', Rule::unique(Product::class, 'title')->ignore($this->id)],
  ...
  public function messages(): array
  {
    return [
      ...
      'volume.numeric' => 'Enter the correct volume.',
      'diameter.numeric' => 'Enter the correct diameter.',
      'height.numeric' => 'Enter the correct height.',
