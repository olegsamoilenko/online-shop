<template>
  <table class=" min-w-full leading-normal border-t-[4px] border-gray-200  lg:border-t-0">
    ...
    <tr v-for="(o, idx) in loadedOrders" :key="o.id"
      ...
      <td class="px-[5px] py-[3px] border-b border-gray-200 text-[14px]" data-label="confirmation">
        <div class="mr-[10px]">
          <p class="text-gray-900 whitespace-no-wrap">{{ getConfirmationStatus(o.no_confirmation_call).label }}</p>
        </div>
      </td>
